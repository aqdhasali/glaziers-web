    ...
    return(
        <>
            ...
            {contentArray.map((i) => (
                <div
                key={i}
                className="bg-[#e5ebff] h-64 border border-[#0e122e] rounded-xl shadow-md flex flex-col gap-5 items-center justify-center p-6"
                >
                    <div className="text-gray-300">
                        {i.icon}
                    </div>
                    <h3 className="text-lg font-semibold mb-2">{i.header}</h3>
