        ...
        <>
            <div className="flex gap-5 justify-center items-center p-6">
                <div className="flex flex-col p-2 w-1/2 gap-2">
                    <h1 className="text-[#6689ff] font-medium text-lg">Our Niche?</h1>
                    <h1 className="font-medium text-4xl">Premium Glass Solutions Tailored for Australian Homes</h1>
                    <ul className="space-y-4">
                        {["Custom Glass Installations ", " Energy-Efficient Double Glazing ", "Safety Glass & Compliance"].map((text, idx) => (
                            <li
                            key={idx}
